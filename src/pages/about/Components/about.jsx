             ...
             <section className='about-1'>
                <div className='container'>
                    <div className="row">
                        ...
                        <div className='col-md-6'>
                        <h3 className='main-heading mt-5'><span className='red-text'>About</span><br/>Wall Rock Developers</h3>
                        <p>With 9 years of experience in the real estate industry, Wall Rock Developers has made its name as a leading commercial and residential property developer. We believe in delivering top-notch construction quality and ensuring the timely completion of our projects. We have a team of experts who comprehensively understand the value of finding your ideal home or the perfect space to start your business. </p>
