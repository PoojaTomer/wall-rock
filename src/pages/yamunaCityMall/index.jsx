...
<li data-aos="fade-up" data-aos-delay="1100" data-aos-offset="0"><span>1000 Families</span> Are Living In A Radius Of 500 Metre</li>
    ...
    return (
        <>
          <Helmet>
            ...
            <LuxuaryRetail
            subTitle="Yamuna City Mall is an ongoing commercial project by Wall Rock Developers which is under construction. This mall is set to be a hub for businesses and entertainment. And it will be one of the best investments for anyone looking to safeguard their future assets."
