...
const testiList = [
    {
      ...
      Description:"I'm delighted to call Aishwaryam home! The building was finished and delivered earlier than expected, and the construction quality is indeed excellent. My apartment's rooms are laid out harmoniously, according to Vastu Shastra.",
    },
    {
      Image:IMAGES.homepage.testProfile2,
      Name:"Mr. Nirbhay Kataria",
      Description:"I am a resident of Aishwaryam, and I can proudly say that the high-quality construction of the building is evident in every corner. The amenities provided are the best. Thank you!",
    },
    {
      Image:IMAGES.homepage.testProfile1,
      Name:"Mr. Harry",
      Description:"I consider myself blessed to live in Aishwaryam. The construction shows incredible attention to detail. I heartily endorse Aishwarayam to anyone looking for a luxurious and beautiful home.",
    },
    {
      Image:IMAGES.homepage.testProfile2,
      Name:"Mr. Owen",
      Description:"Moving to Aishwaryam has been a dream for me and my family. Our two-bedroom apartment is spacious, exquisitely constructed, and furnished with all modern necessities. ",
    },
    {
      Image:IMAGES.homepage.testProfile1,
      Name:"Mr. RamKumar",
      Description:"Being a part of the Aishwaryam community makes me proud. Thanks to Wall Rock Developers' excellent construction, the entire structure emanates elegance and beauty. ",
    },
  ]
