...
import TestProfile1 from "../assets/images/client-icon-1.png";
import TestProfile2 from "../assets/images/client-icon-2.png";
import AishwaryamLogo from "../assets/images/aishwaryam-logo.jpg";
import YamunacityMall from "../assets/images/yamunacity-mall.jpg";
...
export const IMAGES = {
    ...
    homepage :{
        ...
        aishwaryamLogo:AishwaryamLogo,
        // yamunacityMall:[YamunacityMall,Aishwaryam,Article1,Article2],
        // aishwaryam:[YamunacityMall,Aishwaryam,Article1,Article2],
         yamunacityMall:YamunacityMall,
        aishwaryam:Aishwaryam,
    },
    aboutpage:{
